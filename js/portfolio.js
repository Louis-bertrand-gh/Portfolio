  ...
  const buildDOM = () => {
    ...
    if (eduTimeline && DATA.education) {
      DATA.education.forEach((e) => {
        eduTimeline.insertAdjacentHTML(
          "beforeend",
          `
    ...
    if (expTimeline && DATA.experiences) {
      DATA.experiences.forEach((e) => {
        ...
        const skills = e.skills
          ...
          .join("");
        expTimeline.insertAdjacentHTML(
          "beforeend",
          `
          <div class="timeline-item exp-item-with-skills">
            <div class="timeline-period">${e.period}</div>
            <div class="timeline-title">${e.role}</div>
            <div class="timeline-school">${e.company}</div>
            <div class="exp-content-wrapper">
              <div class="exp-column-tasks">
                <ul class="timeline-tasks">${tasks}</ul>
              </div>
              <div class="exp-column-skills">
                <div class="exp-skills-tags">${skills}</div>
              </div>
            </div>
          </div>`,
        );
    ...
    if (qualityList && DATA.qualities) {
      DATA.qualities.forEach((q) => {
        qualityList.insertAdjacentHTML(
          "beforeend",
    ...
    if (interestList && DATA.interests) {
      DATA.interests.forEach((i) => {
        interestList.insertAdjacentHTML(
          "beforeend",
    ...
    if (footer)
      footer.textContent = `© ${new Date().getFullYear()} ${DATA.name} · Tous droits réservés`;
  };
